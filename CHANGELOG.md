...
- 📚 Change imports from @krowdy-ui/styles to @krowdy-ui/core/styles (#17447) @mnemanja

  The presence of two almost identical import paths has been a source of confusion: `@krowdy-ui/styles` and `@krowdy-ui/core/styles`.
  Starting with v4.5.1, the documentation mentions `@krowdy-ui/core/styles` as much as possible.
  ...
  This change removes the need to install the `@krowdy-ui/styles` package directly.
  It prevents the duplication of `@krowdy-ui/styles` in bundles and avoids confusion.
...
- [docs] Change imports from @krowdy-ui/styles to @krowdy-ui/core/styles (#17447) @mnemanja
...
- [Slider] Remove from the lab (#17528) @oliviertassinari
  ...
  +import { Slider } from '@krowdy-ui/core';
  ```
...
- ⚛️ Add two codemods to improve the imports (#16192) @jedwards1211.
  ...
  ```diff
  -import createMuiTheme from '@krowdy-ui/core/styles/createMuiTheme';
  +import { createMuiTheme } from '@krowdy-ui/core/styles';
  ```
  - `top-level-imports`: Converts all @krowdy-ui/core submodule imports to the root module.
...
### `@krowdy-ui/styles@v4.0.0-beta.2`
...
### `@krowdy-ui/styles@v4.0.0-beta.1`
...
### `@krowdy-ui/styles@v4.0.0-beta.0`

- [styles] Add type test for withStyles + ref (#15383) @eps1lon
- [styles] Warn if @krowdy-ui/styles is duplicated (#15422) @oliviertassinari
- [styles] Generate global class names (#15140) @oliviertassinari
...
### `@krowdy-ui/styles@v4.0.0-alpha.8`
...
- [docs] Improve the @krowdy-ui/styles documentation (#15236) @oliviertassinari
...
### `@krowdy-ui/styles@v4.0.0-alpha.7`
...
### `@krowdy-ui/styles@v4.0.0-alpha.6`
...
### `@krowdy-ui/styles@v4.0.0-alpha.5`
...
- Improve the TypeScript definitions of @krowdy-ui/styles @VincentLanglet.
...
- [Box] Remove the unstable prefix & import the right version (#14845) @pheuter
  ...
  ```diff
  -import { unstable_Box as Box } from '@krowdy-ui/core/Box';
...
### `@krowdy-ui/styles@v4.0.0-alpha.4`
...
- [useMediaQuery] Remove unstable prefix (#14593)
  ...
  ```diff
  -import { unstable_useMediaQuery as useMediaQuery } from '@krowdy-ui/core/useMediaQuery';
...
### `@krowdy-ui/styles@v4.0.0-alpha.3`
...
- [styles] Remove the old styles modules (#14767) @oliviertassinari
  ...
  - Remove the `MuiThemeProvider` component:
    ...
    ```diff
    -import { MuiThemeProvider } from '@krowdy-ui/core/styles';
    +import { ThemeProvider } from '@krowdy-ui/styles';
    ```

  - Remove the `@krowdy-ui/styles/install` module.
    ```diff
    -import { install } from '@krowdy-ui/styles';
    -install();
    ```
...
### `@krowdy-ui/styles@v4.0.0-alpha.2`
...
### `@krowdy-ui/styles@v4.0.0-alpha.1`
...
### `@krowdy-ui/icons@v4.0.0-alpha.1`

- [icons] Remove es folder (#14518) @mgansler

### Docs

- [docs] yarn command to add @krowdy-ui/icons (#14502) @Inambe
...
### `@krowdy-ui/styles@v4.0.0-alpha.0`
...
### `@krowdy-ui/icons@v4.0.0-alpha.0`
...
+import Breadcrumbs from '@krowdy-ui/core/Breadcrumbs';
```
...
### `@krowdy-ui/styles@v3.0.0-alpha.10`
...
### `@krowdy-ui/styles@v3.0.0-alpha.9`
...
### `@krowdy-ui/styles@v3.0.0-alpha.8`
...
### `@krowdy-ui/styles@v3.0.0-alpha.7`
...
### `@krowdy-ui/core@v3.8.1`

- Fix utils.chainPropTypes issue

### `@krowdy-ui/styles@v3.0.0-alpha.6`
...
### `@krowdy-ui/styles@v3.0.0-alpha.5`
...
### `@krowdy-ui/styles@v3.0.0-alpha.4`
...
### `@krowdy-ui/styles@v3.0.0-alpha.3`
...
### `@krowdy-ui/styles@v3.0.0-alpha.2`
...
```diff
import Divider from '@krowdy-ui/core/Divider';
...
### `@krowdy-ui/styles@v3.0.0-alpha.1`
...
- Introduce a new `@krowdy-ui/styles` package 💅 (#13503).
...
### `@krowdy-ui/styles@v3.0.0-alpha.0`

- @krowdy-ui/styles (#13503) @oliviertassinari
...
We are upgrading the major version of `@krowdy-ui/core` to match the version of `@krowdy-ui/icons`.
...
```diff
-import AccessAlarm from '@krowdy-ui/icons/es/AccessAlarm';
+import AccessAlarm from '@krowdy-ui/icons/AccessAlarm';
```
...
- After many iterations, we are happy to announce `@krowdy-ui/icons` v2.0.0 💃.
...
- [docs] Update npm downloads badge to point to @krowdy-ui/core (#11590) @davidcalhoun
...
- [StepConnector] Add to default export from @krowdy-ui/core (#11583) @OsipovIgor
...
- [core] Move material-ui to @krowdy-ui/core (#11310) @oliviertassinari
...
```diff
-import CircularProgress from '@krowdy-ui/core/Progress/CircularProgress';
+import CircularProgress from '@krowdy-ui/core/CircularProgress';
```

```diff
-import { ListItem } from '@krowdy-ui/core/List';
+import ListItem from '@krowdy-ui/core/ListItem';
```
...
- [lab] Bump version for @krowdy-ui/icons dependency (#10992) @mbrookes
...
- Move the icon package from `material-ui-icons` to `@krowdy-ui/icons` (#10957) @oliviertassinari

```diff
-import FormatTextdirectionRToL from 'material-ui-icons/FormatTextdirectionRToL';
+import FormatTextdirectionRToL from '@krowdy-ui/icons/FormatTextdirectionRToL';
```
