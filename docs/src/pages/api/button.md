...
| <span class="prop-name">color</span> | <span class="prop-type">'default'<br>&#124;&nbsp;'inherit'<br>&#124;&nbsp;'primary'<br>&#124;&nbsp;'secondary'<br>&#124;&nbsp;'krowdy'<br>&#124;&nbsp;'error'</span> | <span class="prop-default">'default'</span> | The color of the component. It supports those theme colors that make sense for this component. |
...
| <span class="prop-name">textError</span> | <span class="prop-name">.KrowdyButton-textError</span> | Styles applied to the root element if `variant="text"` and `color="error"`.
...
| <span class="prop-name">outlinedError</span> | <span class="prop-name">.KrowdyButton-outlinedError</span> | Styles applied to the root element if `variant="outlined"` and `color="error"`.
...
| <span class="prop-name">containedError</span> | <span class="prop-name">.KrowdyButton-containedError</span> | Styles applied to the root element if `variant="contained"` and `color="error"`.
