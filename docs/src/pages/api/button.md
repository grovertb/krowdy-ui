...
| <span class="prop-name">color</span> | <span class="prop-type">'default'<br>&#124;&nbsp;'inherit'<br>&#124;&nbsp;'primary'<br>&#124;&nbsp;'secondary'<br>&#124;&nbsp;'krowdy'<br>&#124;&nbsp;'danger'</span> | <span class="prop-default">'default'</span> | The color of the component. It supports those theme colors that make sense for this component. |
...
| <span class="prop-name">textKrowdy</span> | <span class="prop-name">.KrowdyButton-textKrowdy</span> | Styles applied to the root element if `variant="text"` and `color="krowdy"`.
| <span class="prop-name">textDanger</span> | <span class="prop-name">.KrowdyButton-textDanger</span> | Styles applied to the root element if `variant="text"` and `color="danger"`.
...
| <span class="prop-name">outlinedKrowdy</span> | <span class="prop-name">.KrowdyButton-outlinedKrowdy</span> | Styles applied to the root element if `variant="outlined"` and `color="krowdy"`.
| <span class="prop-name">outlinedDanger</span> | <span class="prop-name">.KrowdyButton-outlinedDanger</span> | Styles applied to the root element if `variant="outlined"` and `color="danger"`.
...
| <span class="prop-name">containedKrowdy</span> | <span class="prop-name">.KrowdyButton-containedKrowdy</span> | Styles applied to the root element if `variant="contained"` and `color="krowdy"`.
| <span class="prop-name">containedDanger</span> | <span class="prop-name">.KrowdyButton-containedDanger</span> | Styles applied to the root element if `variant="contained"` and `color="danger"`.
