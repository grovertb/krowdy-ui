...
{{"demo": "containers/components/hidden/BreakpointUp.js", "bg": true}}

## Breakpoint down

Using any breakpoint `down` property, the given *children* will be hidden *at or below* the breakpoint.

{{"demo": "containers/components/hidden/BreakpointDown.js", "bg": true}}
...
{{"demo": "containers/components/hidden/BreakpointOnly.js", "bg": true}}
...
{{"demo": "containers/components/hidden/GridIntegration.js", "bg": true}}
