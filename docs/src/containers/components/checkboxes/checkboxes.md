...
{{"demo": "containers/components/checkboxes/Checkboxes.js"}}

`Checkbox` can also be used with a label description thanks to the `FormControlLabel` component.

{{"demo": "containers/components/checkboxes/CheckboxLabels.js"}}

## Checkboxes with FormGroup

`FormGroup` is a helpful wrapper used to group selection controls components that provides an easier API.

{{"demo": "containers/components/checkboxes/CheckboxesGroup.js"}}

## Label placement

You can change the placement of the label:

{{"demo": "containers/components/checkboxes/FormControlLabelPosition.js"}}
...
{{"demo": "containers/components/checkboxes/CustomizedCheckbox.js", "defaultCodeOpen": false}}
