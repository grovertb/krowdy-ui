...
The *Roboto* font will **not** be automatically loaded by Krowdy-UI.
...
Krowdy-UI default typography configuration only relies on 300, 400, 500, and 700 font weights.

## Component

{{"demo": "containers/components/typography/Types.js"}}
...
{{"demo": "containers/components/typography/TypographyTheme.js"}}
